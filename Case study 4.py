'''
1.	The Metro Bank provides various types of loan such as car loans, Business loans and house loans to its account holders. Write a python program to implement the following requirements:
...
•	If the above rules are valid, determine the eligible loan amount and the EMI that the bank can provide to its customer based on their salary and the loan type they expect to avail.
...
Display appropriate error message for the invalid data. If all the business rules are satisfied, the display account number, eligble and requested loan amount and EMI’s.
